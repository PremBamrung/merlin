...
export default function DigestPage() {
  ...
  return (
    <div className="artboard-root">
          ...
          <div className="digest-outer">
            ...
            <div className="digest-layout">
              ...
              <div className="digest-sidebar">
                ...
                <div style={{ marginTop: 16, padding: '14px 16px', background: 'var(--bg-1)', border: '1px solid var(--border)', borderRadius: 10 }}>
                  <div className="mono" style={{ fontSize: 10.5, color: 'var(--text-subtle)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 8 }}>About the digest</div>
                  <p style={{ fontSize: 13, color: 'var(--text-muted)', lineHeight: 1.6, margin: 0 }}>
                    Your recently ingested sources, sorted by recency. Ingest an item to add it to your library, or skip to dismiss it.
                  </p>
                </div>
              </div>
            </div>
      ...
      <style>{`
        .digest-outer { max-width: 1600px; margin: 0 auto; }
        .digest-layout { display: grid; grid-template-columns: 1fr; gap: 28px; }
        @media (min-width: 1400px) {
          .digest-layout { grid-template-columns: 2fr 1fr; align-items: start; }
          .digest-sidebar { position: sticky; top: 20px; }
        }
        .digest-stats {
          display: flex; align-items: center; gap: 20px;
          padding: 14px 18px; background: var(--bg-1);
          border: 1px solid var(--border); border-radius: 10px; margin-bottom: 0;
        }
