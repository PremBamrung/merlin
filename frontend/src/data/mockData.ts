...
export type MockSource = MockVideo | MockBlog | MockReddit;
...
export const VIDEOS: MockVideo[] = [
  ...
  },
  {
    ...
    added: 'yesterday',
    summary:
      'Four hours compressed into two: Karpathy implements a nanoGPT from nothing — tokenizer, attention, MLP blocks, training loop.',
  ...
  },
  {
    ...
    added: '3d',
    summary:
      "A brisk manifesto: ownership, borrowing, and lifetimes aren't obstacles, they're the point.",
    tags: ['rust'],
    topics: [],
  },
];
...
export const BLOGS: MockBlog[] = [
  {
    ...
    added: 'today',
    summary:
      'A candid catalog of what breaks when LLMs meet production: eval gaps, prompt drift, data pipelines, cost surprises.',
  ...
  },
  {
    ...
    added: '2d',
    summary:
      'Why the best interface palettes feel like paper and ink: a meditation on contrast, restraint, and the honest warmth of a single accent.',
    tags: ['design-systems'],
  },
];

export const REDDITS: MockReddit[] = [
  {
    id: 'r1',
    type: 'reddit',
    ...
    added: '5h',
    summary:
      'Thread consensus: local SQLite + embedding index, synced via Syncthing. Obsidian vaults dominate, but a growing cohort is rolling their own frontends.',
    tags: ['pkm'],
  },
];

export const ALL_SOURCES: MockSource[] = [...VIDEOS, ...BLOGS, ...REDDITS];
